...
It's a data structure consists of a few variables. 

2. What is a data matrix in R?  
It's a data structure which looks like a table in excel.
...
```r
spring_matrix <- cbind(spring_matrix, mean_temperature)
spring_matrix
```
