...
R itself is a programming language. It allows us to type in codes and run them.  R studio is a GUI, which makes R more accessible and easier to use. R Studio runs based on R.  GitHub is an online community for programmers. We can use it to upload our codes, as well as share them with public. 
