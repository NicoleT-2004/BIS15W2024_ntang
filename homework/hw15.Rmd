...
Drawbacks: they are kinda "stupid" and cannot get my thought everytime.  
The communication with AI sometimes takes even more time and AI make mistakes when they interpreate the data in a different way.  
Benefits: Saving debuging time when there is only minor issues such as a Chinese ().  
When doing shinyapps, save time because I don't have to input all choices in dropdown sheet by hand.  
10. Do you think you will use AI for coding in the future? Why or why not?
Yes. Shinyapps are really a trouble for me so I wil probably use AI.
